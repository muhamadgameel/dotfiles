...
return require("packer").startup({
    function(use)
        ...
        use {
            ...
            config = function() require "plugins.fix-cursorhold" end
        }

        -- Keys Mapper
        use {
            "lazytanuki/nvim-mapper",
            config = function() require "plugins.nvim-mapper" end
        }

        -- Color Schemes
        use {
            "tomasr/molokai", "morhetz/gruvbox", {"dracula/vim", as = "dracula"}
        }
        ...
        use {
            ...
            {"tpope/vim-commentary"}, {"p00f/nvim-ts-rainbow"},
        ...
        use {
            ...
            {"hrsh7th/cmp-path"}, {"hrsh7th/cmp-calc"}, {"hrsh7th/cmp-emoji"},
        ...
        use {
            ...
            config = function() require "plugins.nvim-cursorword" end
        }
        ...
        use {
            ...
            config = function() require "plugins.range-highlight" end
        }
        ...
        use {
            ...
            config = function() require "plugins.lightspeed-nvim" end
        }
