...
table.insert(
  components.active[1], {
    ...
    right_sep = {{str = " ", hl = {bg = "oceanblue", fg = "NONE"}}, "slant_right_2", " "},
  }
)
...
table.insert(
  components.active[3],
  {provider = "git_branch", hl = {fg = "white", bg = "#3F3F46", style = "bold"}}
)
...
table.insert(
  components.active[3], {provider = "scroll_bar", hl = {fg = "skyblue", style = "bold"}}
)
